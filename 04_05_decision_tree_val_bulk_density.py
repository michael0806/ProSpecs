...
# MAGIC %md
# MAGIC ## This notebook is used for validating the best decision tree modelling for PPP Bulk Density.
...
X_bd_val = datasets["X_bd_val"]
y_bd_val = datasets["y_bd_val"]
...
model_path = "/Workspace/Repos/oce/michael.sun.onesource.APAC-OCE-db/src/ds_projects/prospecs/models/best_decision_tree_model_bulk_density.pkl"
best_model = joblib.load(model_path)

# COMMAND ----------

# Predict using the best model on the validation set
y_val_pred = best_model.predict(X_bd_val)

# Evaluate performance on the validation set
print("Validation Accuracy:", accuracy_score(y_bd_val, y_val_pred))
print("Confusion Matrix:\n", confusion_matrix(y_bd_val, y_val_pred))
print("Classification Report:\n", classification_report(y_bd_val, y_val_pred))

# COMMAND ----------

# Calculate the ROC curve for the best model
y_val_prob_dt = best_model.predict_proba(X_bd_val)[:, 1]
fpr_dt, tpr_dt, _ = roc_curve(y_bd_val, y_val_prob_dt)
